...
if %BUILD_TYPE% equ cmake-vs (
	...
	set FC=%MINGWPREFIX%-gfortran.exe
        sh -lc "pacman-key --keyserver hkp://keyserver.ubuntu.com --refresh-keys"
	sh -lc "pacman -S --noconfirm --needed mingw-w64-x86_64-netcdf mingw-w64-x86_64-openblas mingw-w64-x86_64-arpack mingw-w64-x86_64-gcc mingw-w64-x86_64-gcc-fortran mingw-w64-x86_64-ncurses mingw-w64-x86_64-readline diffutils mingw-w64-x86_64-fftw"
