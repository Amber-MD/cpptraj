...
if %BUILD_TYPE% equ configure-mingw (
	sh -lc "./configure --buildlibs -nohdf5 --with-netcdf=/mingw64 --with-fftw3=/mingw64 --with-bzlib=/mingw64/ --with-zlib=/mingw64 --with-readline=/mingw64/ -shared -windows gnu" || exit /b
