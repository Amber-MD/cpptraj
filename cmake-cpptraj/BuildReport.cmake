...
function(print_build_report)
	...
	color_print_bool("MVAPICH2-GDR for GPU-GPU comm.:   " "${MVAPICH2GDR_GPU_DIRECT_COMM}")
	endif()
	...
	# Release builds should have a prebuilt Amber<version>.pdf that we can install
	color_print_bool("Build Documentation:              " "${AMBER_RELEASE}")
	endif()
