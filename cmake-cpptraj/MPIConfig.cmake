	...
	function(make_mpi_version TARGET NEW_NAME) 
		...
		foreach(LANG ${MAKE_MPI_LANGUAGES})
			...
			if(IS_OBJECT_LIBRARY)
				...
				set_property(TARGET ${NEW_NAME} APPEND PROPERTY LINK_LIBRARIES mpi_${LANG_LOWERCASE})
				set_property(TARGET ${NEW_NAME} APPEND PROPERTY INTERFACE_LINK_LIBRARIES mpi_${LANG_LOWERCASE})
			endif()
