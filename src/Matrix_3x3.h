...
class Matrix_3x3 {
  public:
    ...
    inline Vec3 Translate_Rotate_Translate(Vec3 const&, Vec3 const&, Vec3 const&) const; 
...
/** Calculate (Matrix * (point+T1)) + T2 */
Vec3 Matrix_3x3::Translate_Rotate_Translate(Vec3 const& point, Vec3 const& T1, Vec3 const& T2) const
{
  ...
  return Vec3( x*M_[0] + y*M_[1] + z*M_[2] + T2[0],
               x*M_[3] + y*M_[4] + z*M_[5] + T2[1],
               x*M_[6] + y*M_[7] + z*M_[8] + T2[2] );
