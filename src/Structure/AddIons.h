...
class AddIons {
  public:
    ...
    int InitAddIons(std::string const&, int, std::string const&, int, std::string const&, double, int, int);
  ...
  private:
    ...
    int place_ion(int&, int&, Varray&, DataSet_Coords*, Topology&, Frame&, std::vector<int>&,
                  double, int, std::vector<int>&, VstatArray&, std::string const&) const;

    std::string ion1name_; ///< Name of first ion
    std::string ion2name_; ///< Name of second ion
    std::string ionChainId_; ///< Ion chain ID
