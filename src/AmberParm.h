...
class AmberParm {
  ...
  public:
    ...
    int SetReferenceCoords(Frame *);
    int SetupIntegerMask(AtomMask &);
    int SetupIntegerMask(AtomMask &, Frame &);
    int SetupCharMask(AtomMask &);
    int SetupCharMask(AtomMask &, Frame &);
    ...
    void SetParmName(const char *, const char *);
    ...
    AmberParm *modifyStateByMask(AtomMask&, char*);
   ...
   private:
    ...
    int SetupAtomMask(AtomMask &, bool);
