#ifndef INC_CPPTRAJ_CLUSTER_METRIC_TORSION_H
#define INC_CPPTRAJ_CLUSTER_METRIC_TORSION_H
#include "Metric.h"
class DataSet_1D;
namespace Cpptraj {
namespace Cluster {
/// Metric for delta between points in a 1D scalar DataSet of a torsion (360 deg.).
class Metric_Torsion : public Metric {
  public:
    /// CONSTRUCTOR
    Metric_Torsion();
    ...
    Metric* Copy() { return new Metric_Torsion( *this ); }
