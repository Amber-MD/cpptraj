...
gist doE2016 doorder gridcntr 0.5 0.5 0.5 griddim 1 1 1 gridspacn 1.0 out tip4p.dat refdens 0.0333
EOF
RunCpptraj "$UNITNAME"
DoTest gist-order-norm.dx.save gist-order-norm.dx
...
gist doE2016 doorder gridcntr 0.5 0.5 0.5 griddim 1 1 1 gridspacn 1.0 out tip5p.dat refdens 0.0333
EOF
RunCpptraj "$UNITNAME"
DoTest gist-order-norm.dx.save gist-order-norm.dx
